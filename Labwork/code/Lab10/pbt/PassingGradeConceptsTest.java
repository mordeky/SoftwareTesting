...
import Lab10.domain.PassingGradeConcepts;
...
public class PassingGradeConceptsTest {
    ...
    void passE(@ForAll @FloatRange(min = 5f, max = 6f, maxIncluded = false) float grade){
        PassingGradeConcepts.Concept levelE = PassingGradeConcepts.Concept.E;
        assertEquals(passingGradeConcepts.calculateGrade(grade), levelE);
        return;
    }
